...
3. 本构造与此前至多 13 阶的正面验证曾给出 `14 <= n_min <= 24`。

更新：[`../tournament23/`](../tournament23/) 中的新反例已把仓库当前上界
进一步改进为 23。本构造仍因其简洁的加权吹胀证明而保留。
...
仓库当前更强边界见 23 阶包。正确性依赖构造数据、严格二阶邻域定义、
Hall 定理和公开验证器。目前尚未同行评审，也没有证明 24 为最小阶数。
